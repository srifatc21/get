                        ...
                        <div style="margin-top: 43px; margin-left: 25px;">
                            <div class="font-weight-bold">
                                <div class="d-flex justify-content-end" style="letter-spacing: 3px;">
                                    <span class="pr-2" style="cursor: default; font-size: 33px;font-style: italic">CALL US FOR FREE :</span>
                                    <span class="text-dark pl-1" style="font-size: 55px;margin-top: -16px;"><a href="tel:0330 113 9686" style="text-decoration: none;">0330 113 9686</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="footer-text" style="margin-top: 10px;">
            <span style="font-weight: bold">
                ...
                COMPANY NUMBER: 10833649, REGISTERED OFFICE: 27A BROADWAY, PETERBOROUGH, PE1 1SQ. GET
